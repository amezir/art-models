...
const cubeMaterials = [
    ...
    new THREE.MeshBasicMaterial({ color: 0x000000 }),
    new THREE.MeshBasicMaterial({ color: 0x000000 }),
    new THREE.MeshBasicMaterial({ map: texture_portal, transparent: true }),
    new THREE.MeshBasicMaterial({ color: 0x000000 })
];
...
const cubeGeometry2 = new THREE.BoxGeometry(31, 31, 31);
...
const interiorMaterial = [
    new THREE.MeshBasicMaterial({ map: fond, side: THREE.BackSide }),
    new THREE.MeshBasicMaterial({ map: fond, side: THREE.BackSide}),
    new THREE.MeshBasicMaterial({ map: fond, side: THREE.BackSide}),
    new THREE.MeshBasicMaterial({ map: fond, side: THREE.BackSide}),
    new THREE.MeshBasicMaterial({ map: texture_portal2, transparent: true , side: THREE.BackSide}),
    new THREE.MeshBasicMaterial({ map: fond, side: THREE.BackSide})
];
